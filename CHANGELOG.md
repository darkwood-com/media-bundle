...
- Require `darkwood/flow` `^8.1`
- Upgrade symfony/flex and QA tooling (PHP CS Fixer, Rector, PHPStan, PHPUnit)
...
- Add Seedance 2.0 fast preset and video pipeline updates
- Enhance configuration with `when@dev` support
- Align dependency on `darkwood/flow` to unified `^1.3` line

## Prior releases (pre-unified versioning)

## v1.0.0

- Initial satellite release (media generation bundle)
