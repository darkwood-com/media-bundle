...
final class JsonTrailerProjectMapperRenderingPersistenceTest extends TestCase
{
    public function test_clip_render_and_project_rendering_round_trip(): void
    {
        ...
        $scene->setClipRender([
            ...
            'details' => [],
            'scene_mp4_path' => '/var/trailers/p/scenes/1-intro/scene.mp4',
            'skip_reason' => null,
            'used_voice' => false,
        ...
        $project = new TrailerProject(
            ...
            updatedAt: $updated,
            rendering: [
                'scenario_mp4_path' => '/var/trailers/p/render/scenario.mp4',
