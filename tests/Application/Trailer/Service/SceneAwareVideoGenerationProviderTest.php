...
{
    /** TRAILER_REAL_FOR_FIRST_SCENE_ONLY=1 → scene 1 real, scenes 2+ fake */
    ...
    /** TRAILER_REAL_FOR_FIRST_SCENE_ONLY=1 → scenes 2+ fake */
    ...
    /** TRAILER_REAL_FOR_FIRST_SCENE_ONLY=0 → all scenes real */
