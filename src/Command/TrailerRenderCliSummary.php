 ...
 */
final class TrailerRenderCliSummary
{
    public static function write(SymfonyStyle $io, TrailerGenerationResult $result): void
    {
        self::writeSceneClipTable($io, $result->project);
        self::writeScenarioAndManifest($io, $result);
    }

    private static function writeSceneClipTable(SymfonyStyle $io, TrailerProject $project): void
    {
        $io->writeln('');
    ...
    private static function writeScenarioAndManifest(SymfonyStyle $io, TrailerGenerationResult $result): void
    {
        $io->writeln('');
